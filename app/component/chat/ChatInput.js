...
export default function ChatInput({ 
  ...
  return (
    <div className="border-t border-gray-200 dark:border-gray-800 p-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-3 bg-gray-100 dark:bg-gray-800 rounded-2xl p-2">
          <input
            type="text"
            value={chatInput}
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white rounded-xl transition-all transform hover:scale-105 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
